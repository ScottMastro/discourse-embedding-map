...
class AddSuperclusterColumns < ActiveRecord::Migration[8.0]
  def change
    add_column :ai_topic_projections, :supercluster_idx, :integer

    create_table :ai_topic_superclusters do |t|
